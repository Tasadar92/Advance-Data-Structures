...
public class LinkedBinarySearchTree<E> implements BinarySearchTree<E> {
    ...
    public Position<E> first() {
    	Position<E> pos = binTree.root();
    	
    	while(binTree.hasLeft(pos)){
    		pos = binTree.left(pos);
    	}
        return pos;	
    }
    ...
    public Position<E> last() {
    	...
    	while(binTree.hasRight(pos)){
    		pos = binTree.right(pos);
    	}
        return pos;
    }
	...
	public Iterable<Position<E>> successors(Position<E> pos) {
		...
		while(!nodeQueue.isEmpty()){
			...
			Position<E> newPos = sucessor(aux);
			
			if(newPos != null){
				l.add(newPos);
				nodeQueue.add(newPos);
			}	
		}
	...
	public Iterable<Position<E>> predecessors(Position<E> pos) {
		...
		Deque<Position<E>> nodeQueue = new LinkedList();
		ArrayList<Position<E>> l = new ArrayList<>();
		Position<E> min = minimum(binTree.root());
		...
		while(!nodeQueue.isEmpty()){
			...
			if(newPos != null && !newPos.equals(sucessor(pos))){
				l.add(newPos);
				nodeQueue.add(newPos);
			}	
		}
